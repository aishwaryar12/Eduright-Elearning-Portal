...
CUSTOM_TOOLBAR = [
    {
        ...
        "items": [
            ...
            "Find", "Replace", "SelectAll", "Scayt", "PasteFromWord", '-',
            "ShowBlocks", "Maximize"
    ...
    },
    {
        "name": "document",
        "items": [
            "Font", "FontSize", "Bold", "Italic", "Underline", "Strike", "Subscript", "Superscript", "RemoveFormat",
            "-",
            "TextColor", "BGColor", "-",
    ...
    },
    {
        ...
        "items": [
            ...
            "Styles", "Format", "Image", "MediaEmbed", "CodeSnippet", "Table", "HorizontalRule", "Smiley",
            "SpecialChar", "-",
            "Blockquote", "-",
